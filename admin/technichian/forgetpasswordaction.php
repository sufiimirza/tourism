<?php
require_once ($_SERVER['DOCUMENT_ROOT'].'/tourism/vendor/autoload.php');

// Create the Transport
$transport = (new Swift_SmtpTransport('smtp.gmail.com', 465, 'ssl'))
    ->setUsername('tourismsystemmy@gmail.com')
    ->setPassword('Tourism123');
...
function sendResetPasswordEmail($userEmail, $token)
{
    ...
    $message = (new Swift_Message('Reset Password'))
        ->setFrom('tourismsystemmy@gmail.com')
        ->setTo($userEmail)
