...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $update = true;
    $record = mysqli_query($con, "SELECT * FROM city WHERE city_id=$id");
			...
			<div class=" col-xs-12">
				<div class="box-content card white">
					...
					<div class="card-content">
						<?php
						$id=$_GET['city_id'];
						$sql="select a.city_id,a.city_name,a.postcode,b.state_name from city a join state b on a.state_id=b.state_id Where city_id='$id'";
						...
						?>
						<form class="form-horizontal" action="cityupdate.php" method="post" >
							<div class="form-group">
               					<label for="city_id" class="col-sm-3 control-label">City ID</label>
								<div class="col-sm-9">       				
            					<input type="text" class="form-control" name="city_id" id="city_id" readonly value="<?php echo $row['city_id']; ?>">
             					</div>
             				</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="postcode" pattern="[0-9]{5}" value="<?php echo $row['postcode'] ?>">
								</div>
							</div>
							...
							<div class="form-group">
             					<label for="state_id" class="col-sm-3 control-label">State</label>
             						<div class="col-sm-9">
             					 		<tr>
               					 		<td height="35"><select class="form-control select2_1" name="state" id="boxx" required onchange="myplandetail(this.value)">
								 		<option class="form-control select2_1" value="">-- Please select --</option>
								 		<?php
							...
							?>
								...
								<div class="col-sm-8">
									<button type="update" class="btn btn-info btn-sm waves-effect waves-light">EDIT CITY</button>
								</div>
							<!-- <div class="form-group">
