			...
			<div class=" col-xs-12">
				<div class="box-content card white">
					...
					<div class="card-content">
						<form class="form-horizontal" action="state_submit.php" method="post" enctype="multipart/form-data">
						
							<div class="form-group">
								<label for="city_name" class="col-sm-3 control-label">City Name</label>
								<div class="col-sm-9">									
									<input type="text" name="state_name"  class="form-control" placeholder="City Name">
								</div>
							</div>
							<div class="form-group">
								<label for="postcode" class="col-sm-3 control-label">State Photo</label>
								<div class="col-sm-9">
									<input type="file" class="form-control" name="state_photo" id="state_photo">
								</div>
							</div>
							<div class="col-sm-8">
									<button type="submit" class="btn btn-info btn-sm waves-effect waves-light">ADD STATE</button>
								</div>
							<!-- <div class="form-group">
