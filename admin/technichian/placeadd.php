		...
		<div class="row small-spacing">
			...
			<div class="col-xs-12">
				<div class="box-content card white">
					<h4 class="box-title">Add Attraction Place</h4>
					<!-- /.box-title -->
					<div class="card-content">
						<form class="form-horizontal" action="placesubmit.php" method="post" enctype="multipart/form-data">
							<div class="form-group">
               				<label for="place_id" class="col-sm-3 control-label">Place ID</label>
							<div class="col-sm-9">        				
							<?php
            				...
            				?>
            				<input type="text" class="form-control" name="Iplace_id" id="Iplace_id" readonly value="<?php echo getRandomWord(); ?>">

             				</div>
             			</div>
							<div class="form-group">
								<label for="city_name" class="col-sm-3 control-label">Place Name</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Place Detail</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="place_details" id="place_details" placeholder="description">
								</div>
							</div>
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Price Ticket</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="ticket_price" id="ticket_price">
								</div>
							</div>
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Child Price</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="child_price" id="child_price">
								</div>
							</div>
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Place Email</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="place_email" id="place_email">
								</div>
							</div>
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Place Latitude</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="placeLatitude" id="placeLatitude">
								</div>
							</div>
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Place Longitude</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="placeLongitude" id="placeLongitude">
								</div>
							</div>
							<div class="form-group">
								<label for="state_name" class="col-sm-3 control-label">Place Photo</label>
								<div class="col-sm-9">
									<input type="file" class="form-control" name="place_photo" id="place_photo">
								</div>
							</div>
							<div class="col-sm-8">
									<button type="submit" class="btn btn-info btn-sm waves-effect waves-light">ADD PLACE</button>
								</div>
							<!-- <div class="form-group">
