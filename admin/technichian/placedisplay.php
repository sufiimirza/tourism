...
<head>
	...
	<title>Place Display -  Admin </title>
							    ...
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        // $result1 = mysqli_query($con, $query1);
							                ...
							                echo "<td>" . $row['place_details'] . "</td>";?>
					       					 ...
					       					 <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['place_photo']); ?> " controls width='100px' height='100px'> </td>

											<td><a href="placeedit.php?Iplace_id=<?php echo $row['Iplace_id']; ?>" class='btn' style='background: lightblue;'>EDIT</a><br><br></td>
					        				<?php
							                $sno++;
