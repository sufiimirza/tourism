...
<head>
	...
	<title>Profile - Malaysia Tourism System</title>
					...
					<div class="col-xs-12">
						...
						?>					
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											<div class="col-xs-5"><label>Admin ID:</label></div>
											<!-- /.col-xs-5 -->
											<div class="col-xs-7"><?php echo $id ;?> </div>
											<!-- /.col-xs-7 -->
										</div>
										<!-- /.row -->
									</div>
									...
									<div class="col-md-6">
										<div class="row">
											...
											<td><a href="profileedit.php?admin_id=<?php echo $id; ?>" class='btn' style='background: lightblue;'>EDIT</a><br><br></td>
										<!-- /.row -->
									</div>
									</div>
									<!-- /.col-md-6 -->
