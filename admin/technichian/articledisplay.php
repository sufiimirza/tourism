...
<head>
	...
	<title>Article Display - Admin</title>
		...
		<div class="row small-spacing">
			...
			<div class=" col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Article List</h4>
					<!-- /.box-title -->
					...
					<table class="table table-striped">
						...
						<tbody> 
							<?php
							$query  = "select * from article where admin_name='$aname'";
							// echo $query;
							$result = mysqli_query($con, $query);
							$sno    = 1;
							...
							if (mysqli_affected_rows($con) != 0) {
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        // $result1 = mysqli_query($con, $query1);
							                ...
							                ?>
							                <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['article_link']); ?> " controls width='100px' height='100px'> </td>

					       					
											<td><a href="articleedit.php?article_id=<?php echo $row['article_id']; ?>" class='btn' style='background: lightblue;'>EDIT</a><br><br></td>
					        				<?php
							                $sno++;
