			...
			<div class=" col-xs-12">
				<div class="box-content card white">
					...
					<div class="card-content">
						<form class="form-horizontal" action="city_submit.php" method="post" >
            				...
            				?>
            				<input type="text" class="form-control" name="city_id" id="city_id" readonly value="<?php echo getRandomWord(); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="postcode" id="postcode" placeholder="postcode" pattern="[0-9]{5}">
								</div>
							</div>
							...
							<div class="col-sm-8">
									<button type="submit" class="btn btn-info btn-sm waves-effect waves-light">ADD CITY</button>
								</div>
							<!-- <div class="form-group">
