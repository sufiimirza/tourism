...
<head>
	...
	<title>Hotel Display -  Admin </title>
			...
			<div class=" col-xs-12">
				<div class="box-content">
					...
					<table class="table table-striped">
						...
						<tbody> 
							<?php
							$query  = "select a.hotel_id,a.hotel_name,b.city_name, a.hotel_detail, a.hotel_photo,a.hotel_no,a.hotel_email,a.hotel_rate from hotel a join city b on a.city_id=b.city_id ORDER BY a.hotel_name";
							// echo $query;
							$result = mysqli_query($con, $query);
							$sno    = 1;
							...
							if (mysqli_affected_rows($con) != 0) {
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        // $result1 = mysqli_query($con, $query1);
							                ...
							                echo "<td>" . $row['hotel_no'] . "</td>";

							                echo "<td>" . $row['hotel_email'] . "</td>";

							                echo "<td>" . $row['hotel_rate'] . "</td>";

							                echo "<td>" . $row['hotel_detail'] . "</td>";?>

					       					 <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['hotel_photo']); ?> " controls width='100px' height='100px'> </td>

											<td><a href="hoteledit.php?hotel_id=<?php echo $row['hotel_id']; ?>" class='btn' style='background: lightblue;'>EDIT</a><br><br></td>
					        				<?php
							                $sno++;
