			...
			<div class=" col-xs-12">
				<div class="box-content">
					...
					<table class="table table-striped">
						...
						<tbody> 
							<?php
							$query  = "select a.city_name, b.place_name, b.count_visit, AVG(c.rating) as averageplace, count(c.feedback_ID) as count1 from city a join places b on a.city_ID=b.city_ID join feedback c on b.Iplace_ID=c.Iplace_ID group by place_name order by averageplace desc" ;
							// echo $query;
							$result = mysqli_query($con, $query);
							$sno    = 1;
