...
<body class="home page-template-default page page-id-3102 woocommerce-no-js ppb_enable">
   ...
   <?php include 'sidebar.php' ;?>
    ...
    <?php include 'navbar.php' ;?>
            ...
            <?php
                            $type  = $_GET['rest_type'];
                            $querypic = "select res_photo from restaurant where rest_type='$type' order by rand() limit 1";
                            $resultpic = mysqli_query($con, $querypic);

                            $ano=1;
                                if (mysqli_affected_rows($con) != 0) {
                                while ($row1 = mysqli_fetch_array($resultpic, MYSQLI_ASSOC)) {
                                    $avg1=$row1['res_photo'];
                                    $ano++;
                                }
                            }
        ...
        <div id="page_caption" class="hasbg parallax    " style="background-image:url(data:image/jpg;charset=utf8;base64,<?php echo base64_encode($avg1); ?>);">
                ...
                <div class="page_title_inner">
                    <div class="page_title_content">
                        ...
                        <div class="page_tagline">
                            Find your best place to enjoy the meals </div>
                    </div>
                </div>
            </div>
        ...
        <div id="page_content_wrapper" class="hasbg ">
            <!-- <form id="tour_search_form" name="tour_search_form" method="get" action="http://themes.themegoods.com/granddemo/tours/tour-2-columns-grid/">
                ...
                <div class="inner_wrapper nopadding">
                    ...
                    <div id="page_main_content" class="sidebar_content full_width fixed_column">
                        ...
                        <div class="standard_wrapper">
                            ...
                            $rtype=$_GET['rest_type'];
                            $query2  = "select * from restaurant where rest_type = '$rtype'";
                            // echo $query;
                            ...
                            if (mysqli_affected_rows($con) != 0) {
                                while ($row = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
                                    ...
                                    $rdetail    = $row['rest_detail'];
                                    $rphoto = $row['res_photo'];
                                    ?>
                                    
                                <div class="element grid classic2_cols animated<?php '$rno' ?>;">

                                      <div class="one_half gallery2 grid static filterable portfolio_type themeborder" data-id="post-3" style="background-image:url(data:image/jpg;charset=utf8;base64,<?php echo base64_encode($rphoto); ?>);">
                                        ...
                                        <div class="portfolio_info_wrapper">
                                            ...
                                            <div class="tour_attribute_wrapper">
                                                ...
                                                <div class="tour_attribute_days">
                                                    <span class="ti-time"></span><?php echo $rhour ?></div>
                                            </div>
