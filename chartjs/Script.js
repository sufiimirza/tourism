	...
	if(count==0){
		...
		var element=document.getElementById("navbarcollapse");
		 element.className = element.className.replace("page-container sidebar-collapsed", "page-container");
		  ...
		  if(datacount==0)
		  	elementdata.className=elementdata.className.replace("","has-sub");
		  else if(datacount==1)
		  	elementdata.className=elementdata.className.replace("","has-sub opened");

		  if(schedulecount==0)
		  	elementschedule.className=elementschedule.className.replace("","has-sub");
		  else if(schedulecount==1)
		  	elementschedule.className=elementschedule.className.replace("","has-sub opened");
...
function initializeMember(){
	...
	elementdata=document.getElementById("datahassubopen");
	elementschedule=document.getElementById("schedulehassubopen");
...
function memberExpand(passvalue){
	...
	if(passvalue==1){
		if(memcount==0){
		    ...
		    if(datacount==1){
		    	elementdata.className=elementdata.className.replace("has-sub opened","has-sub");

				var element=document.getElementById("dataExpand");
				 element.className = element.className.replace("visible", "");
			 	  datacount=0;
		    ...
		    if(schedulecount==1){
		    	elementschedule.className=elementschedule.className.replace("has-sub opened","has-sub");

				var element=document.getElementById("scheduleExpand");
				 element.className = element.className.replace("visible", "");
			 	  schedulecount=0;
		...
		if(datacount==0){
		   ...
		   if(memcount==1){
		     ...
		     if(routinecount==1){
				elementtoutine.className=elementtoutine.className.replace("has-sub opened","has-sub");
			...
			elementdata.className=elementdata.className.replace("has-sub","has-sub opened");

			var element5=document.getElementById("dataExpand");
		...
		if(schedulecount==0){
		   ...
		   if(memcount==1){
			...
			elementschedule.className=elementschedule.className.replace("has-sub","has-sub opened");

			var element6=document.getElementById("scheduleExpand");
