...
<body class="home page-template-default page page-id-3102 woocommerce-no-js ppb_enable">
   ...
   <!-- Begin template wrapper -->
    <?php include 'navbar.php' ;?>
        ...
        <div id="page_caption" class="hasbg parallax    " style="background-image:url(upload/food.jpg);">
                ...
                <div class="page_title_inner">
                    <div class="page_title_content">
                        ...
                        <div class="page_tagline">
                            Explore all the Malaysia's cuisine </div>
                    </div>
                </div>
            </div>
    ...
    <div id="page_content_wrapper" class="hasbg ">
        <!-- <form id="tour_search_form" name="tour_search_form" method="get" action="http://themes.themegoods.com/granddemo/tours/tour-2-columns-classic/">
                        ...
                        <div id="portfolio_filter_wrapper" class="gallery classic three_cols portfolio-content section content clearfix" data-columns="3">
                            ...
                            if (mysqli_affected_rows($con) != 0) {
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    ...
                                    <a class="tour_image" name="res_photo" href="restaurantdetail.php?restaurant_ID=<?php echo $id ?>">
                                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['res_photo']);  ?> " />

                                
                                    </a>

                                    <div class="portfolio_info_wrapper">
                                        <a class="tour_link" href="#"><h4><?php echo $row['restaurant_name'] ?></h4></a>
                                        <div class="tour_excerpt">
                                            <p><?php echo $row['rest_detail'] ?></p>
                                        </div>
