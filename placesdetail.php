...
<head>
    ...
    <title>Places | Malaysia Tourism System</title>
...
<body class="home page-template-default page page-id-3102 woocommerce-no-js ppb_enable">
 ...
 $coordinates1 = array();
    ...
    $longitudes1 = array();
                            ...
                            $aname  = $_GET['Iplace_ID'];
                            $query  = "select a.place_name,a.city_ID, a.place_email,a.Iplace_ID, a.ticket_price,a.child_price, a.place_details, a.opening_hour, a.closing_hour, a.place_photo,a.closing_hour,a.placeLatitude, a.placeLongitude, c.state_name from state c join city b on c.state_ID=b.state_ID join places a  on a.city_id=b.city_id where Iplace_ID= '$aname'";
                            // echo $query;
                            ...
                            if (mysqli_affected_rows($con) != 0) {
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    ...
                                    $detail= $row['place_details'];
                                    $pemail =$row['place_email'];
                                    $pcity =$row['city_ID'];
                                    $close =$row['closing_hour'];
                                    $latitudes1[] = $row['placeLatitude'];
                                    $longitudes1[] = $row['placeLongitude'];
                                    $coordinates1[] = 'new google.maps.LatLng(' . $row['placeLatitude'] .','. $row['placeLongitude'] .'),';
                             ...
                             $lastcount1 = count($coordinates1)-1;
                             $coordinates1[$lastcount1] = trim($coordinates1[$lastcount1], ","); 
                                    ?>
...
<?php
        $queryavg= "select ROUND(AVG(rating),1) as avg1 from feedback where Iplace_ID='$aname'";
...
<!-- 
                                ...
                                <a id="single_tour_share_button" href="mailto:<?php echo $pemail ?>" class="button ghost themeborder"><span class="ti-email"></span>For Any Inquiries</a>
                                ...
                                $query5  = "select * from hotel where city_id='$pcity' order by rand() limit 3";
                                ...
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    ...
                                    ?>
                                        ...
                                        <br class="clear" />
                                       <!--  <div class="one gallery1 grid static filterable portfolio_type themeborder" style="background-image:url(upload/bf1202aedf2c5b6a57d379575619a488-700x466.jpg);">
...
-->
                        <ul class="single_tour_departure_wrapper themeborder">                 
                            ...
                            <li>
                                <div class="single_tour_departure_title">Ticket Price</div>
                                <div class="single_tour_departure_content">
                                    <div class="one_half ">
                                        <span class="ti-check"></span>Adult: </div>
                                    <div class="one_half last">
                                        RM</span><?php echo $price ?> </div>
                                    <div class="one_half ">
                                        <span class="ti-check"></span>Children: </div>
                                    <div class="one_half last">
                                        RM</span><?php echo $child ?> </div>
                                </div>
                            </li>
                        ...
                        <div class="fullwidth_comment_wrapper sidebar">
                            ...
                            var mapOptions = {
                            zoom: 18,
                            center: {<?php echo'lat:'. $latitudes1[0] .', lng:'. $longitudes1[0] ;?>}, //{lat: --- , lng: ....}
              ...
              startPoint1 = {<?php echo'lat:'. $latitudes1[0] .', lng:'. $longitudes1[0] ;?>};
              endPoint1 = {<?php echo'lat:'.$latitudes1[$lastcount1] .', lng:'. $longitudes1[$lastcount1] ;?>};
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-dFHYjTqEVLndbN2gdvXsx09jfJHmNc8&callback=initMap"></script>
                            ...
                            <div>
                                ...
                                <?php
                                        ...
                                        $aname2=$_GET['Iplace_ID'];
                                        $query3="select * from feedback where Iplace_ID='$aname2'";
            ...
            <div id="respond" class="comment-respond">
                ...
                <?php
                $aname1=$_GET['Iplace_ID'];

                ?>
                <form action="reviewsubmit.php" method="post" id="commentform" class="comment-form">
                     <!-- <input type="hidden" id="Iplace_ID" name="Iplace_ID" value=/> -->
                    <p class="comment-notes"><span id="email-notes">Your email address will not be published.</span> Required fields are marked <span class="required">*</span></p>
                    <p class="comment-form-author">
                        <label for="id">Place ID <span class="required">*</span></label>
                        <input id="id" name="Iplace_ID" type="text" value="<?php echo $aname1 ?>" size="30" maxlength="245" readonly />
                    </p>
    ...
    <div class="tour_related">
        <h3 class="sub_title">Suggested Restaurant</h3>
        <div id="portfolio_filter_wrapper" class="gallery classic three_cols portfolio-content section content clearfix" data-columns="3">
            <?php

            $query5  = "select * from restaurant where city_id='$pcity' order by rand() limit 3";
                                $result = mysqli_query($con, $query5);
                                $rno    = 1;
            ...
            <div class="one_third gallery3 classic static filterable portfolio_type themeborder" data-id="post-171">
                ...
                <a class="tour_image" href="restaurantdetail.php?restaurant_ID=<?php echo $id ?>">
                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($photo); ?> " >
                </a>

                <div class="portfolio_info_wrapper">
                    <a class="tour_link" href="restaurantdetail.php?restaurant_ID=<?php echo $id ?>"><h4><?php echo $rname ?></h4></a>
                    <div class="tour_excerpt">
                        <p></p>
                    </div>
                    <div class="tour_attribute_days">
                            <span class="ti-time"></span> <?php echo $hour ?> </div>
