...
<body class="home page-template-default page page-id-3102 woocommerce-no-js ppb_enable">
   ...
   <?php include 'sidebar.php' ;?>
    ...
    <?php include 'navbar.php' ;?>
        ...
        <div id="page_caption" class="hasbg parallax    " style="background-image:url(images/hotel.png);">
                ...
                <div class="page_title_inner">
                    <div class="page_title_content">
                        ...
                        <div class="page_tagline">
                            Find a place for you to rest ! </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="standard_wrapper">
                            ...
                            if (mysqli_affected_rows($con) != 0) {
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                     ...
                                     $hrating = $row['hotel_rate'];
                                    
                                    // $query1  = "select * from city ORDER BY city_name";
                                    // $result1 = mysqli_query($con, $query1);
                                    ?>

                                <div class="element grid classic4_cols animated<?php $id ?>;">

                                    <div class="one_half gallery2 grid static filterable portfolio_type themeborder" data-id="post-2" style="background-image:url(data:image/jpg;charset=utf8;base64,<?php echo base64_encode($hphoto); ?>);">
